...
\begin{frame}{Modelo CAD}
    \scriptsize
    Se muestra el modelo CAD completo con los tres mecanismos ensamblados, motores y sistemas de transmisi\'on incluidos. El mecanismo de abducci\'on del pulgar (pi\~n\'on-cremallera) sigue en dise\~no (v\'ease Figura \ref{fig:vistas}).
