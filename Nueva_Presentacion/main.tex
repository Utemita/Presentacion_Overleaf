...
\begin{frame}{Base de Datos}
    \small
    \textbf{Dataset de Pizzolato et al. (2017)}
    \begin{itemize}
...
\begin{frame}{Trayectorias Articulares de Referencia}
    \small
    Trayectorias (x, y) de las tres articulaciones del dedo \'indice durante el agarre de pinza fina, extra\'idas de la base de datos (v\'ease Figura \ref{fig:tray_art}).

    \begin{figure}
        \centering
        \includegraphics[width=0.95\linewidth]{imagens/trayectorias_articulares.png}
