...
\begin{frame}{Introducci\'on}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \begin{itemize}
                \item La pinza fina es una funci\'on motora que implica la coordinaci\'on de los dedos (pulgar e \'indice) para sujetar objetos peque\~nos con precisi\'on. Su deterioro afecta la calidad de vida \cite{kim2017}.
                \item Condiciones como los ACV causan deterioro en la motricidad fina, generando p\'erdida de independencia en actividades diarias \cite{kim2017}.
                \item La rehabilitaci\'on asistida por exoesqueletos permite ejercicios repetitivos y precisos, disminuyendo la carga para terapeutas \cite{ueki2012}\cite{Fukui2025}.
                \item El presente proyecto desarrolla un exoesqueleto de eslabones r\'igidos para los tres dedos principales del agarre de pinza fina, permitiendo movimiento en las tres articulaciones principales del dedo.
            \end{itemize}
        \end{column}
...
\begin{frame}{Tipos de Agarre Humano}
    \begin{center}
        La taxonom\'ia GRASP clasifica los tipos de agarre humano. Los agarres de precisi\'on (pinza fina) involucran principalmente el pulgar y el \'indice para manipular objetos peque\~nos con control fino \cite{Feix2016}\cite{gardenia2022}.
    \end{center}

    \begin{figure}
        \centering
        \includegraphics[width=0.85\linewidth]{imagens/agarres.png}
        \caption{Taxonom\'ia GRASP de tipos de agarre humano}
    \end{figure}
\end{frame}
